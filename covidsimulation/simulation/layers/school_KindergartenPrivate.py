...
import numpy as np
LAYER_KEY = 'school_KindergartenPrivate'

class School_KindergartenPrivate(NetworkLayer):
    ...
    def fromParams(self, population):
        ...
        # filtered_indexes = chooseUniform(np.array(filtered_indexes), int(len(filtered_indexes)*self.percentage_included))
        # self._createConnectionsUniform(
        #     population, 
        #     filtered_indexes,
        #     self.size[0],
        #     self.size[1])
